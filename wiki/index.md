...
23. [[papers/L1/2021-NE-hd-truck-depot-charging|Borlaug et al. 2021, Nature Energy]] — *Heavy-duty truck electrification and the impacts of depot charging on electricity distribution systems*. Zotero `9TCC3G32`. Address `c-000032`. Archetype: bottom-up duty-cycle modeling + distribution-substation impact screen. Headline: 36 substations modeled; depot charging at ≤100 kW per vehicle accommodated by most without upgrades. **L1 batch-5**, borderline scope (transport-fuel use).

## Papers ingested — L2 (batch-5 pilot, 2026-05-11)

24. [[papers/L2/hydrogen-p2x/2024-ECM-h2-mobility-sardinia-tea|Pettinau et al. 2024, ECM]]. Zotero `83CEHMNG`, address `c-000025`, L2-A hydrogen-p2x. Archetype: site-specific TEA with dual perspective (LCOH + investor NPV/IRR/payback). Headline: 12.5 MWp PV + 5 MW electrolyzer in Sardinia; €4.09/kg LCOH, €2.97/kg with O2+excess-e revenue; FCEV bus still not cost-competitive vs diesel.
25. [[papers/L2/hydrogen-p2x/2020-AE-offshore-wind-h2-hybrid-investor|McDonagh et al. 2020, Applied Energy]]. Zotero `4UG5EFDW`, address `c-000026`, L2-A hydrogen-p2x. Archetype: investor-NPV across 3 OWF-H2 configurations. Headline: hybrid (curtailment+SMC-triggered electrolysis) requires H2 price > €4.2/kg to increase NPV; pure-grid still beats pure-PtG.
26. [[papers/L2/hydrogen-p2x/2024-RSER-offshore-wind-h2-iberian|Calado et al. 2024, RSER]]. Zotero `EHNWITKT`, address `c-000027`, L2-A hydrogen-p2x. Archetype: hourly TEA + NN forecasting for regulation costs. Headline: onshore electrolyzer beats offshore on LCOH at all horizons (5.84/3.42/2.57 vs 8.98/4.37/2.68 €/kg in 2020/2030/2050).
27. [[papers/L2/hydrogen-p2x/2019-AE-wind-h2-ldv-ercot|Nagasawa et al. 2019, Applied Energy]]. Zotero `DBULMZ89`, address `c-000028`, L2-A hydrogen-p2x. Archetype: dual-method (county-level demand + LP dispatch on marginal price). Headline: 2015 TX wind could supply ~22% of Texas-Triangle LDV H2 demand; production favorable 1-6am in most markets except CA.
28. [[papers/L2/power-systems/2021-AiAE-flexible-loads-h2-curtailment|Ruggles et al. 2021, Advances in Applied Energy]]. Zotero `H4VD5GZN`, address `c-000029`, L2-A power-systems. Archetype: macro energy model + flexible-load fraction sweep. Headline: 25%+ flexible load addable to firm-load-optimized RE system with ~10% capacity expansion + 10-20% cost reduction. **Bank-row champion** (23 candidates).
29. [[papers/L2/ai-data-driven/2017-AE-ml-wind-forecasting-deep-feature|Feng et al. 2017, Applied Energy]]. Zotero `W86HHD6H`, address `c-000030`, L2-B ai-data-driven. Archetype: two-layer ML ensemble + deep feature selection. Headline: 30% RMSE improvement vs single-algorithm baselines across 7 sites.

**Awaiting decision**:
- `c-000031` reserved-unused: Shi et al. 2020 ACSSCE *Fluctuation Analysis of Complementary Wind-Solar System for H2*. Codex self-aborted: ACSSCE not in `applied_flagship` vocab lock list. Add to vocab OR treat as L3 manual bank.
