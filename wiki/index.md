...
- Address counter at `c-000019` (16 TPL paper addresses in use: `c-000003` through `c-000018`).
...
13. [[papers/2021-NCC-h2-efuels-potential-risks|Ueckerdt et al. 2021, Nature Climate Change]] — *Potential and risks of hydrogen-based e-fuels in climate change mitigation*. Zotero `UIWZD5EE`. Address `c-000015`. Archetype: risk-perspective on H2 e-fuels with quantified efficiency, cost, and emissions consequences of premature deployment vs delayed scale-up. Headline: e-fuels are 5x more electricity-hungry than direct electrification; should be reserved for narrow non-electrifiable niches.
